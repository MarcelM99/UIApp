...
const ChatComponent = ({photo,level,name,lastText,time,navTo,screenName}) => {
  return (
    <View style={styles.background}>
      ...
      style={styles.scrollView}
        ...
        pagingEnabled={true}>
        <View
          style={styles.visibleView}>
            <TouchableOpacity style={styles.navigationButton} onPress={() => navTo(screenName)}>
          <CircularProgress
            value={level}
